...
echo "  HEAD~3..HEAD~2  →  PriceFormatter change (leaf node)"
echo "  HEAD~2..HEAD~1  →  DiscountCalculator change (mid-level ripple)"
echo "  HEAD~1..HEAD    →  New file added (CurrencyConverter)"
echo "  HEAD~0..HEAD    →  TaxCalculator + CheckoutHandler multi-change"